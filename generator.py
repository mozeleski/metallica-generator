...
class Generator:
    ...
    def __get_captcha(self):
        ...
        return captcha_result.json()['request']
    ...
    def create_account(self):
        ...
        data = {
            ...
            'dwfrm_profile_register_phone': script_config["phone"],
            ...
            'g-recaptcha-response': self.__get_captcha(),
        ...
        print(f'create response... {createAcc.status_code}')
